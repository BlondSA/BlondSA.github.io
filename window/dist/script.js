...
/* harmony import */ var _modules_tabsSlider__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/tabsSlider */ "./src/js/modules/tabsSlider.js");
...
var deadline = "2021-07-10";
window.addEventListener("DOMContentLoaded", function () {
  "use strict";

  Object(_modules_changeModalState__WEBPACK_IMPORTED_MODULE_4__["default"])(modalState);
  Object(_modules_modals__WEBPACK_IMPORTED_MODULE_1__["default"])();
  Object(_modules_tabsSlider__WEBPACK_IMPORTED_MODULE_2__["default"])(".glazing_slider", ".glazing_block", ".glazing_content", "active");
  Object(_modules_tabsSlider__WEBPACK_IMPORTED_MODULE_2__["default"])(".decoration_slider", ".no_click", ".decoration_content > div > div", "after_click");
  Object(_modules_tabsSlider__WEBPACK_IMPORTED_MODULE_2__["default"])(".balcon_icons", ".balcon_icons_img", ".big_img > img", "do_image_more", "inline-block");
...
var changeModalState = function changeModalState(state) {
  ...
  var bindActionToElements = function bindActionToElements(event, elements, prop) {
        ...
        switch (item.nodeName) {
          ...
          case "INPUT":
            if (item.getAttribute("type") === "checkbox") {
              ...
              elements.forEach(function (box, k) {
                box.checked = false;
...
var forms = function forms(state) {
  ...
  var closeWindows = function closeWindows() {
    var modalWindow = document.querySelector("inputs"),
...
var images = function images() {
  ...
  workSection.addEventListener("click", function (e) {
    ...
    if (target && target.classList.contains("preview")) {
      ...
      imgPopup.style.cssText = "display: flex; align-items: center; justify-content: center;";
...
var modals = function modals() {
  ...
  var showModuleByTime = function showModuleByTime(selector, time) {
    setTimeout(function () {
  ...
  bindModal(".popup_calc_profile_button", ".popup_calc_end", ".popup_calc_end_close", false); // showModuleByTime(".popup", 60000);
};
...
var tabsSlider = function tabsSlider(headerSelector, tabSelector, contentSelector, activeClass) {
...
/* harmony default export */ __webpack_exports__["default"] = (tabsSlider);
